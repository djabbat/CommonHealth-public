...
- **Terminology overlap:** символ `χ_Ze` в MCOA — биомаркер старения. В Ze Theory `χ_Ze` не используется напрямую, но потенциальная путаница в экосистеме CommonHealth.
