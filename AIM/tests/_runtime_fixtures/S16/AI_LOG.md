...
-    `dx_guess` (dx): U=0.762 (𝒞=0.18, Φ_Ze=0.99, Ethics=0.82) — Dx guess без обследований
- ⭐ `clarify` (clarify): U=0.948 (𝒞=1.00, Φ_Ze=1.00, Ethics=0.87) — Уточнить анамнез, запросить labs
-    `cbc` (test): U=0.790 (𝒞=0.18, Φ_Ze=0.99, Ethics=0.89) — CBC + CMP
...
## 2026-04-30 21:52:41 — triage by scenario

**Alternatives considered:** 3

-    `dx_guess` (dx): U=0.786 (𝒞=0.30, Φ_Ze=0.99, Ethics=0.82) — Dx guess без обследований
- ⭐ `clarify` (clarify): U=0.903 (𝒞=0.77, Φ_Ze=1.00, Ethics=0.87) — Уточнить анамнез, запросить labs
-    `cbc` (test): U=0.797 (𝒞=0.22, Φ_Ze=0.99, Ethics=0.89) — CBC + CMP
